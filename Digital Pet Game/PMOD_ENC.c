...
// Returns the status of the PD0 through PD3 pins
...
// Determines the direction of the rotary encoder as it rotates
...
// Two functions return the status of the button and the switch on the PMOD ENC module
